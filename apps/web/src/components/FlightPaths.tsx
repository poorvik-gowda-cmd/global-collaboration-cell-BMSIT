...
const AirplaneRoute = ({
  ...
  const pathD = `M ${String(ORIGIN.x)},${String(ORIGIN.y)} Q ${String(route.controlPoint.x)},${String(route.controlPoint.y)} ${String(route.destination.x)},${String(route.destination.y)}`;
